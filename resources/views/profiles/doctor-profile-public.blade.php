        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                <div class="container bootstrap snippet">
                    <div class="row">
                        <div class="m-2 ml-3">
                            <h1 class="text-primary">{{$doctorProfile->user->name}}</h1>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4"><!--left col-->
                            <div class="text-center">
                                <img src="{{$doctorProfile->profileImage()}}" class="rounded w-100 img-thumbnail float-left" alt="">
                                ...
                                <div class="tab-pane active" id="home">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" readonly class="form-control" value="{{$doctorProfile->name.' '.$doctorProfile->surname}}" name="first_name" id="first_name" placeholder="first name" title="enter your first name if any.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-inline">
                                        <div class="col-xs-2">
                                            ...
                                            <input type="text" readonly class="form-control" value="{{$doctorProfile->getAge()}}" name="age" id="age" placeholder="age" title="enter your age if any.">
                                        </div>

                                        <div class="col-xs-1 ml-xl-auto">
                                            <label for="specialization"><h4>Specialization</h4></label>
                                            <input type="text" readonly class="form-control" value="{{$doctorProfile->doctorSpecialization->name}}" name="specialization" id="specialization" placeholder="specialization" title="enter your specialization if any.">
                                        </div>

                                        <div class="col-xs-2 pt-1">
                                            <label for="phone" class="text-left"><h4>Phone</h4></label>
                                            <input type="text" readonly class="form-control" value="{{$doctorProfile->phone}}" name="age" id="age" placeholder="age" title="enter your age if any.">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="email" readonly class="form-control" value="{{$doctorProfile->user->email}}" name="email" id="email" placeholder="you@email.com" title="enter your email.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" readonly class="form-control" value="{{$doctorProfile->street}}" name="mobile" id="mobile" placeholder="no street to display" title="enter your mobile number if any.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="email" readonly class="form-control" value="{{$doctorProfile->locality}}" id="location" placeholder="somewhere" title="enter a location">
                                        </div>
                                    </div>
                                </div><!--/tab-pane-->
                            </div><!--/tab-pane-->
